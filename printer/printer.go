...
func (p *Printer) printBinaryLogicalAnd(n node.Node) {
	...
	p.Print(nn.Left)
	io.WriteString(p.w, " "+dictionary.FindWord("and")+" ")
	p.Print(nn.Right)
}
...
func (p *Printer) printExprEmpty(n node.Node) {
	...
	io.WriteString(p.w, dictionary.FindWord("empty")+"(")
	p.Print(nn.Expr)
	io.WriteString(p.w, ")")
}
...
func (p *Printer) printExprInclude(n node.Node) {
	...
	io.WriteString(p.w, dictionary.FindWord("include")+" ")
	p.Print(nn.Expr)
}
...
func (p *Printer) printExprYieldFrom(n node.Node) {
	...
	io.WriteString(p.w, "yield from ") //YIELDFROM??
	p.Print(nn.Expr)
}
...
func (p *Printer) printExprYield(n node.Node) {
	...
	io.WriteString(p.w, dictionary.FindWord("yield")+" ")
...
func (p *Printer) printStmtAltFor(n node.Node) {
	...
	io.WriteString(p.w, dictionary.FindWord("endfor")+";")
}
...
func (p *Printer) printStmtClass(n node.Node) {
	...
	io.WriteString(p.w, dictionary.FindWord("class"))
...
func (p *Printer) printStmtClassConstList(n node.Node) {
	...
	io.WriteString(p.w, dictionary.FindWord("const")+" ")
...
func (p *Printer) printStmtDefault(n node.Node) {
	nn := n.(*stmt.Default)
	io.WriteString(p.w, dictionary.FindWord("default")+":")
...
func (p *Printer) printStmtDo(n node.Node) {
	nn := n.(*stmt.Do)
	io.WriteString(p.w, dictionary.FindWord("do"))
...
func (p *Printer) printStmtInterface(n node.Node) {
	...
	io.WriteString(p.w, dictionary.FindWord("interface"))
